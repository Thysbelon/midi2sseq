...
5. Run [sseq2mid](https://github.com/Thysbelon/sseq2mid) with the command `./sseq2mid --loopstyle2 input.sseq` to convert the sseq file containing the song you wish to edit to midi.
